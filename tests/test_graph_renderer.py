...
def test_player_footer_display_and_window_metadata_contracts() -> None:
    ...
    assert "const footer = M.hunt_hint" in template
    assert '`generated by ${M.generator || "sigwood"} · hunt this log: ${M.hunt_hint}`' in template
    assert '`generated by ${M.generator || "sigwood"} · hunt logs like this: sigwood hunt PATH`' in template
