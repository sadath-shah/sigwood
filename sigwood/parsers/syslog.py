...
def parse_timestamp(raw: str) -> datetime | None:
    ...
    The wall-clock is interpreted as HOST-LOCAL time - the timezone rsyslog and
    dnsmasq write in - and converted to true UTC on return (DST gap/fold edges
    take the stdlib's naive-astimezone defaults). RFC 3164 carries no year: the
    current local year is the starting point, with a rollback heuristic - a
    result more than 7 days in the future belongs to the previous year.
